...
import java.io.*; import java.nio.file.*; import java.util.Locale;
public final class BoomboxClientConfig {
    private static final Path CONFIG_DIR = FabricLoader.getInstance().getConfigDir().resolve(LazoBoombox.MOD_ID);
    ...
    private static volatile int xOffset = 8, yOffset = 8; private static volatile boolean timerVisible = true;
    ...
    public static HudPosition getPosition() { return position; } public static int getXOffset() { return xOffset; } public static int getYOffset() { return yOffset; } public static boolean isTimerVisible() { return timerVisible; }
