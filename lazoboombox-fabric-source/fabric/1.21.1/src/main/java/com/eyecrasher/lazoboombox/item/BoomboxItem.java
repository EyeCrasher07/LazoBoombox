...
public class BoomboxItem extends BlockItem {
    ...
    @Override public net.minecraft.world.InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        if (player.isShiftKeyDown()) { InteractionResult r = smartInteractHeld(level, player, usedHand); return new net.minecraft.world.InteractionResultHolder<>(r, player.getItemInHand(usedHand)); }
